# Projeto em Python chamado "ETL_BCB"
...
Faz a requisição na API do BCB de dados trimestrais de meios de pagamentos a partir de uma data e trimestre.
Parâmetro: 
Data no formato: AAAAT, EX.: 20191

#### Função salvarCSV:

Recebe um DataFrame e salva de disco um arquivo .CSV
Parâmetros:
